...
import src.engine.player.AI.BoardEvaluator;
...
public class TestBoard {
    ...
    public void initialBoard() {
        ...
        assertEquals(StandardBoardEvaluator.get().evaulate(board, 0), 0);
    ...
    public void testPlainKingMove() {
        ...
        System.out.println(evaluator.evaulate(board, 0));
        assertEquals(StandardBoardEvaluator.get().evaulate(board, 0), 0);
        ...
        assertEquals((int) moveTransition.getTransitionBoard().whitePlayer().getPlayerKing().getPiecePosition(), (int)61);
